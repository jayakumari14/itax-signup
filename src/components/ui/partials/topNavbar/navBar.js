...
import UserInfo from './topNavbarComponents/userInfo.js';
import { MdOutlineLocalGroceryStore } from 'react-icons/md';
import { StyledLink, Itag } from '@/components/ui/styles/globalStyle.jsx';
import { StoreContext } from '@/store/store-context.js';
import BillShillLink from '@/components/billShillLink';
...
export default function Navbar(props) {
    ...
    return (
        ...
        >
            ...
            <div
                id="dropdown"
                className={`${hamburger ? null : 'hidden'
